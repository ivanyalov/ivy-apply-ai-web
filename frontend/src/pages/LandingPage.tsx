...
const LandingPage: React.FC = () => {
	...
	return (
		<div className="min-h-screen bg-gray-50 relative overflow-hidden">
			{/* Hero Section */}
			<section className="py-24 px-6 text-center relative z-10 bg-gray-50">
			...
			<section className="py-24 px-6 relative z-10 bg-gray-50">
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
						{/* Benefit 1 */}
						<div className="group relative">
							<div className="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:border-harvard-crimson/30 h-[220px] flex flex-col">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
						...
						<div className="text-center md:text-left group">
							<div className="flex items-center justify-center md:justify-start mb-6">
								<div className="w-12 h-12 bg-gradient-to-br from-harvard-crimson/20 to-red-600/20 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
									<svg className="w-6 h-6 text-harvard-crimson" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
									</svg>
								</div>
								<h4 className="text-xl font-bold text-white group-hover:text-harvard-crimson transition-colors duration-300">
						...
						<div className="text-center md:text-right group">
							<div className="flex items-center justify-center md:justify-end mb-6">
								<h4 className="text-xl font-bold text-white group-hover:text-harvard-crimson transition-colors duration-300 mr-4">
									{t.landing.footer.features}
								</h4>
								<div className="w-12 h-12 bg-gradient-to-br from-harvard-crimson/20 to-red-600/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
									<svg className="w-6 h-6 text-harvard-crimson" fill="none" stroke="currentColor" viewBox="0 0 24 24">
