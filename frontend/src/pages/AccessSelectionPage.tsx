      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        {subscription?.hasAccess && (
          <div className="text-center mt-8">
            <button onClick={() => navigate('/chat')} className="bg-harvard-crimson text-white px-6 py-2 rounded-lg text-lg font-semibold hover:bg-red-800 transition-colors">
              Перейти в чат
            </button>
          </div>
        )}
        ...
        {trialSuccess && (
          <div className="mt-4 text-green-600 text-center font-semibold">Пробный период успешно активирован!</div>
        )}
      </div>
    </div>
  );
