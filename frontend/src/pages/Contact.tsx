    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-harvard-crimson to-red-600 px-8 py-6 border-b-2 border-white">
            <div className="flex items-center space-x-3">
              <span className="text-2xl">📞</span>
														<h1 className="text-lg md:text-xl lg:text-2xl font-bold text-white">{t.legal.contact.title}</h1>
            </div>
              ...
              <div className="markdown-content text-gray-700 leading-relaxed">
                <ReactMarkdown
                  components={{
                    ...
                    a: ({children, href}) => <a href={href} className="text-gradient-to-r from-harvard-crimson to-red-600 hover:from-red-700 hover:to-red-800 underline transition-colors" target="_blank" rel="noopener noreferrer">{children}</a>
                  }}
                >
                  {contact}
                </ReactMarkdown>
        ...
        <div className="mt-8 flex justify-between items-center">
          ...
          >
            ...
            <span>{t.legal.contact.navigation.publicOffer}</span>
          </button>
