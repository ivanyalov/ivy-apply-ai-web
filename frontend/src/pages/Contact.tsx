              ...
              <div className="markdown-content text-gray-700 leading-relaxed">
                <ReactMarkdown
                  components={{
                    ...
                    a: ({children, href}) => <a href={href} className="text-harvard-crimson hover:text-red-700 underline transition-colors" target="_blank" rel="noopener noreferrer">{children}</a>
                  }}
                >
                  {contact}
                </ReactMarkdown>
