      ...
      <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex justify-between items-center">
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-7 h-7 text-gray-700">
            ...
            <rect x="5" y="6" width="14" height="14" rx="2" strokeLinejoin="round"/>
      ...
      <div className="border-t border-gray-200 px-6 py-4">
        <div className="flex space-x-4">
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`w-7 h-7 transition-colors
              ${isLoading || (!inputText.trim() && !attachedFile)
                ? 'text-gray-700'
                : 'text-harvard-crimson'}
            `}>
              <polygon points="3 20 21 12 3 4 7 12 3 20" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" fill="none" />
            </svg>
          </button>
        </div>
      </div>
