export const en = {
  landing: {
    ...
    faq: {
      ...
      q1: {
        ...
        answer: "Our AI is based on advanced language models specifically trained for university admission consulting. It can analyze documents, answer questions, and provide personalized recommendations."
      },
      q2: {
        question: "Is my data secure?",
        answer: "Yes, we take data security seriously. All uploaded documents and conversations are encrypted and securely stored."
      },
      q3: {
        question: "What types of documents can I upload?",
        answer: "You can upload essays, transcripts, recommendation letters, and other admission-related documents in various formats."
      }
    },
    footer: {
      title: "Ivy Apply AI",
  ...
  chat: {
    ...
    welcomeMessage: "Hello! I'm your AI admissions assistant. I can help you with essays, school selection, application guidance, and answer any questions about university admissions. How can I help you today?",
    clearChatMessage: "Chat cleared! I'm ready to help you with your university admission questions.",
  ...
  subscription: {
    ...
    verifyEmailMessage: "To subscribe and activate your trial period, you need to verify your email address. Check your email at {email} and click the link in the message.",
  ...
  registrationSuccess: {
    ...
    confirmationSent: "",
    checkEmail: "Please check your email and click the link in the message to verify your email address.",
    ...
    noEmailReceived: "Didn't receive the email? Check your spam folder or proceed to the plan selection page to resend."
  },
  emailVerification: {
